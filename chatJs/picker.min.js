	...
	([function (e, t, i) {
													...
													this.on("refresh", function () {
														if (e.pages = [], e.wrapperWidth && e.wrapperHeight && e.scrollerWidth && e.scrollerHeight) {
															...
															if (e.options.snap === !0)
																...
																for (u = e.options.snap, h = u.length, p = -1; l < h; l++)
													...
													if (this.enabled && a.eventType[e.type] === this.initiated && (this.initiated = !1, this.options.preventDefault && !(0, a.preventDefaultException)(e.target, this.options.preventDefaultException) && e.preventDefault(), this.trigger("touchend", {
														...
														if (!this.moved) {
															if (this.options.wheel) {
																...
																this.options.tap && (0, a.tap)(e, this.options.tap), this.options.click && (0, a.click)(e);
														...
														if (this.options.momentum && o < this.options.momentumLimitTime && (l > this.options.momentumLimitDistance || s > this.options.momentumLimitDistance)) {
															...
															this.options.wheel && (i = Math.round(i / this.itemHeight) * this.itemHeight, h = this.options.adjustTime);
														var u = a.ease.swipe;
														...
														if (t !== this.x || i !== this.y)
															return (t > 0 || t < this.maxScrollX || i > 0 || i < this.maxScrollY) && (u = a.ease.swipeBounce), void this.scrollTo(t, i, h, u);
				...
				function r(e) {
					...
					e.registerHelper("with", function (e, t) {
						if (u(e) && (e = e.call(this)), !s.isEmpty(e))
							return t.fn(e)
					}),
				...
				function r(e, t) {
					...
					n = {
						...
						merge: function (e, t) {
							var i = e || t;
							return e && t && e !== t && (i = {}, h.extend(i, t), h.extend(i, e)),
							i
						},
				...
				function h(e, t) {
					...
					if (t.singleton) {
						...
						e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = l(t), n = u.bind(null, i), r = function () {
							s(i),
